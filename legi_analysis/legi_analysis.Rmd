...
**Background:**
The annual LD notification rate in the EU/EEA increased from 1.0-1.4 per 100,000 during 2011-2016 to 1.8-2.2 in 2017-2019.

**Aim:**
The aim of this study was to analyse whether the increase observed was statistically and consistently higher than the one expected and whether there was a marked change in trend during this period. Moreover, we aimed to assess if there were differences according to age, gender, or importation of infection. 

**Methods:**
We used 2012-2019 data from the European Surveillance System (TESSy) reported by EU/EEA Member States. A retrospective prediction by dynamic regression model was created from 2012-2016 data to analyse the percentage increase in cases in 2017-2019. Interrupted time series analysis was also performed to determine if there had been a significant change in trend in 2017-2019 compared with the previous five years.

**Results:** 
Overall, we found a 33.4% increase in cases in 2017-2019 compared with what was predicted. The ITS also found a significant trend increase in 2017-2019 compared with 2012-2016. All stratifications had cases above the predicted at an increase of 20-47%, and a significant trend increase was observed mostly among older age groups, males, and domestic cases. 

**Conclusion:**
Our study indicates an increasing trend in LD cases during 2017-2019 compared with the previous five years, and the distribution of cases per week suggests an overall amplification of the seasonal trends. These findings suggest that LD may be an infectious disease of significant risk for increase and importance in the European region in coming years.

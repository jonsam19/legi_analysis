...
p <- ECDC_plot(forecast_europe, europe) +
  ggtitle("Weekly LD cases by date of onset (2012-2019) with retrospective prediction of 2017-2019 
          based on a 2012-2016 model, EU/EEA")
ggplotly(p)

excess_fun(forecast_europe)

cat("#### Model & residuals \n")
analysis_fun(model_europe)
```
...
p <- ECDC_plot(forecast_europe, europe) +
  ggtitle("Weekly LD cases by date of onset (2012-2019) with retrospective prediction of 2017-2019 
  based on a 2012-2016 model, imported cases, EU/EEA")
ggplotly(p)
...
p <- ECDC_plot(forecast_europe, europe) +
  ggtitle("Weekly LD cases by date of onset (2012-2019) with retrospective prediction of 2017-2019 
  based on a 2012-2016 model, domestic cases, EU/EEA")
ggplotly(p)
...
p <- ECDC_plot(forecast_europe, europe) +
  ggtitle("Weekly LD cases by date of onset (2012-2019) with retrospective prediction of 2017-2019 
  based on a 2012-2016 model, age <40, EU/EEA")
ggplotly(p)
...
p <- ECDC_plot(forecast_europe, europe) +
  ggtitle("Weekly LD cases by date of onset (2012-2019) with retrospective prediction of 2017-2019 
  based on a 2012-2016 model, age 40-49, EU/EEA")
ggplotly(p)
...
p <- ECDC_plot(forecast_europe, europe) +
  ggtitle("Weekly LD cases by date of onset (2012-2019) with retrospective prediction of 2017-2019 
  based on a 2012-2016 model, age 50-59, EU/EEA")
ggplotly(p)
...
p <- ECDC_plot(forecast_europe, europe) +
  ggtitle("Weekly LD cases by date of onset (2012-2019) with retrospective prediction of 2017-2019 
  based on a 2012-2016 model, age 60-69, EU/EEA")
ggplotly(p)
...
p <- ECDC_plot(forecast_europe, europe) +
  ggtitle("Weekly LD cases by date of onset (2012-2019) with retrospective prediction of 2017-2019 
  based on a 2012-2016 model, age 70-79, EU/EEA")
ggplotly(p)
...
p <- ECDC_plot(forecast_europe, europe) +
  ggtitle("Weekly LD cases by date of onset (2012-2019) with retrospective prediction of 2017-2019 
  based on a 2012-2016 model, age 80+, EU/EEA")
ggplotly(p)
...
p <- ECDC_plot(forecast_europe, europe) +
  ggtitle("Weekly LD cases by date of onset (2012-2019) with retrospective prediction of 2017-2019 
  based on a 2012-2016 model, males, EU/EEA")
ggplotly(p)
...
p <- ECDC_plot(forecast_europe, europe) +
  ggtitle("Weekly LD cases by date of onset (2012-2019) with retrospective prediction of 2017-2019 
  based on a 2012-2016 model, females, EU/EEA")
ggplotly(p)
...
## 2017 interrupted time series {.tabset}
### All cases {.tabset}
#### Results
...
its_fun(europe)
ggplotly(p + ggtitle("Weekly LD cases by date of onset (2012-2019) with ITS trend line, EU/EEA"))

its_table %>% 
  kable(col.names=c("Term", "Estimate", "95% Confidence interval", "P-value"), 
        digits=3, caption="Regression results") %>%
    kable_styling(bootstrap_options = c("striped", "condensed"))

cat("#### Residuals \n")
residuals <- checkresiduals(its_model)
```
...
its_fun(Imported)
ggplotly(p + ggtitle("Weekly LD cases by date of onset (2012-2019) with ITS trend line, imported, EU/EEA"))
...
its_fun(unknown)
ggplotly(p + ggtitle("Weekly LD cases by date of onset (2012-2019) with ITS trend line, domestic, EU/EEA"))
...
its_fun(age40)
ggplotly(p + ggtitle("Weekly LD cases by date of onset (2012-2019) with ITS trend line, age <40, EU/EEA"))
...
its_fun(age4049)
ggplotly(p + ggtitle("Weekly LD cases by date of onset (2012-2019) with ITS trend line, age 40-49, EU/EEA"))
...
its_fun(age5059)
ggplotly(p + ggtitle("Weekly LD cases by date of onset (2012-2019) with ITS trend line, age 50-59, EU/EEA"))
...
its_fun(age6069)
ggplotly(p + ggtitle("Weekly LD cases by date of onset (2012-2019) with ITS trend line, age 60-69, EU/EEA"))
...
its_fun(age7079)
ggplotly(p + ggtitle("Weekly LD cases by date of onset (2012-2019) with ITS trend line, age 70-79, EU/EEA"))
...
its_fun(age80)
ggplotly(p + ggtitle("Weekly LD cases by date of onset (2012-2019) with ITS trend line, age 80+, EU/EEA"))
...
its_fun(male)
ggplotly(p + ggtitle("Weekly LD cases by date of onset (2012-2019) with ITS trend line, males, EU/EEA"))
...
its_fun(female)
ggplotly(p + ggtitle("Weekly LD cases by date of onset (2012-2019) with ITS trend line, females, EU/EEA"))
